    ...
    <div style={{ display: "flex", minHeight: "100vh" }}>
      ...
      <main style={{ flex: 1, marginLeft: 210, padding: "48px 56px" }}>
        ...
        <div style={{ marginBottom: 40 }}>
          ...
          <p style={{ fontSize: 13, color: "var(--t4)", marginTop: 6, fontWeight: 300 }}>Phase 1 · Prochain entretien : dim. 4 mai</p>
        </div>
            ...
            <CardBody>
              {accounts.map((a, i) => (
                <div key={a.label} style={{
                  ...
                  padding: "14px 0", borderBottom: i < accounts.length - 1 ? "1px solid rgba(255,255,255,.03)" : "none",
                }}>
                  <div>
                    <div style={{ fontSize: 13, fontWeight: 400, color: "var(--t2)" }}>{a.label}</div>
